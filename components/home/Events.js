    ...
    return (
      <section id="wrapper">
        <div
          ...
          style={{
            backgroundImage: `linear-gradient(rgb(20 20 40 / 60%), rgb(20 20 40 / 60%)), url(${researchpaper.src})`,
            backgroundAttachment: "unset",
          }}
        >
          <div className="w-100">
            <h1 className="big-text mb-4">Our Research Papers</h1>
            <Link href="/research-papers" passHref>
              <button type="button" className="btn filled-btn">
                View Researches
              </button>
            </Link>
            <div className="row event-wrap">{contents}</div>
          </div>
        </div>
      </section>
    );
