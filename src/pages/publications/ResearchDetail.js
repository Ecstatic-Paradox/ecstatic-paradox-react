                            ...
                            <div className="col-xl-8">
                                ...
                                <div className="blog-detail-head w-100 d-flex align-items-center my-4">
                                    <div className="avatar d-flex align-items-center">
                                        <img src="https://images.pexels.com/photos/9396342/pexels-photo-9396342.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="Avatar" />
                                        <h2 className="ms-3">John Doe</h2>
                                    </div>
                                    <div className="d-flex align-items-center ms-5">
                                        <span className="me-2">
                                            <svg width="25" viewBox="0 0 512 512">
                                                <rect x="48" y="80" width="416" height="384" rx="48" fill="none" stroke="currentColor" stroke-linejoin="round" stroke-width="30"></rect>
                                                <path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="30" d="M128 48v32M384 48v32M464 160H48M304 260l43.42-32H352v168M191.87 306.63c9.11 0 25.79-4.28 36.72-15.47a37.9 37.9 0 0011.13-27.26c0-26.12-22.59-39.9-47.89-39.9-21.4 0-33.52 11.61-37.85 18.93M149 374.16c4.88 8.27 19.71 25.84 43.88 25.84 28.59 0 52.12-15.94 52.12-43.82 0-12.62-3.66-24-11.58-32.07-12.36-12.64-31.25-17.48-41.55-17.48"></path>
                                            </svg>
                                        </span>
                                ...
                                <h1>HOW TO MAKE WORLD BETTER ?</h1>


                                <div className="blog-detail-content">
                                    <img src="https://images.pexels.com/photos/1287145/pexels-photo-1287145.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="blog" />
                            ...
                            <div className="col-xl-4">
                                ...
                                <div className="research-author text-center">
                                    ...
                                    <div className="author-details">
                                        <img src="https://images.pexels.com/photos/4355346/pexels-photo-4355346.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="author" />
                                        <h2>Corazon Brown</h2>
                                        <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quis accumsan eu, adipiscing nunc diam donec id nulla.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
