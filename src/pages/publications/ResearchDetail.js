                            ...
                            {item.author.map((author, i) => {
                                return (
                                    <div key={i} className="author-details">
                                        {author.avatar ? <img src={`${baseURL}${author.avatar}`} alt="author" /> : <img src={paradoxlogo} alt="author" />}
                                        <h2>{author.first_name} {author.last_name}</h2>
                                        <div className="core-member-icon justify-content-center">
                                            {author.linkedIn_profile ? <a href={author.linkedIn_profile} target="_blank" rel="noopener noreferrer">
                                            ...
                                            {author.personal_website ? <a href={author.personal_website} target="_blank" rel="noopener noreferrer">
