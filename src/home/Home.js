      ...
      <React.Fragment>
          ...
          >
            <SwiperSlide>
              <div
                ...
                style={{
                  backgroundImage:
                    'linear-gradient(rgb(20 20 40 / 30%), rgb(20 20 40 / 30%)), url("https://images.pexels.com/photos/3225517/pexels-photo-3225517.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500")',
                }}
              >
        ...
        <section id="wrapper">
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgb(20 20 40 / 60%), rgb(20 20 40 / 60%)), url("https://images.unsplash.com/photo-1504384308090-c894fdcc538d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=1050&q=80")',
            }}
          >
            <div>
              ...
              <h6 className="small-text">
                ...
                <br /> Vitae cumque error consectetur!Veniam,
                <br /> minus eius Laboriosam.
              </h6>
              <button type="button" className="btn filled-btn">
                Learn About Us
              </button>
            ...
            <div className="row align-items-center">
              <div className="col-md-7 pe-md-5">
                <div className="cta-details">
                  ...
                  <p className="small-text">
                    ...
                    Vehicula malesuada in sit commodo velit dictum. Urna, proin
                    lorem non lectus consequat. Amet at lacus, maecenas egestas
                    viverra mi, nec morbi ac. Vehicula tortor nibh nunc, aliquam
                    tincidunt in egestas sit nibh. Bibendum nisl.vulputate
                    malesuada in sit commodo velit dictum. Urna, proin lorem non
                    lectus consequat. “
                  </p>
                </div>
              </div>
              ...
              <div className="col-md-5">
                <div className="cta-img p-md-5">
                  <img
                    src="https://images.pexels.com/photos/411207/pexels-photo-411207.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
                    alt="Call to action"
                  />
                </div>
              </div>
        ...
        <section id="wrapper">
          <div
            className="cover text-center justify-content-center"
            style={{
              backgroundImage:
                'linear-gradient(rgb(20 20 40 / 60%), rgb(20 20 40 / 60%)), url("https://images.pexels.com/photos/8761540/pexels-photo-8761540.jpeg?auto=compress&cs=tinysrgb&dpr=3&h=750&w=1260")',
          ...
          <div className="blog-wrap container-fluid">
            <div className="blog-card">
              <div className="blog-img">
                <img
                  src="https://images.pexels.com/photos/4144179/pexels-photo-4144179.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
