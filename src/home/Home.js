            ...
            <React.Fragment>
                            ...
                            <ul className="navbar-nav ms-auto">
                                ...
                                <li className="nav-item dropdown">
                                    ...
                                    <ul className="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                        <li><a className="dropdown-item" href="project.html">Action</a></li>
                                        <li><a className="dropdown-item" href="project.html">Another action</a></li>
                                        <li><a className="dropdown-item" href="project.html">Something else here</a></li>
                                    </ul>
                                </li>
                                <li className="nav-item">
                ...
                <section id="wrapper">
                    <div className="hero-section">
                        <div>
                            <h1 className="big-text">Lorem Ipsum Dolor Sit Amet, <br />Consectetur Adipiscing</h1>
