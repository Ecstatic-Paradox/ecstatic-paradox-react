...
export default class ResearchPapers extends Component {
  ...
  fetchPapers = async () => {
    try {
      const data = await fetch(`${baseURL}/api/researchpapers/`);
  ...
  render() {
    ...
    const content = items.map((item, index) => {
      if (index % 2 === 0) {
        return (
          <div key={item.meta.id} className="research-highlight-detail">
            <div className="research-overview">
              <div className="row">
                ...
                <div className="col-md-12 col-xl-5 mb-5">
                  ...
                  <Link href={`research-papers/${item.slug}`} passHref>
                    <a>
      ...
      <>
        ...
        <section id="wrapper">
          <div
            ...
            style={{
              backgroundImage: `linear-gradient(rgb(20 20 40 / 60%), rgb(20 20 40 / 60%)), url(${researchcover.src})`,
              backgroundPosition: "center",
            }}
          >
            <h1 className="big-text">Research Paper</h1>
            <p className="small-text">
              Our extensive and collaborative efforts to contribute in the
              mainstream sciences
            </p>
          </div>
        </section>
                        ...
                        <div className="research-overview">
                            <div className="row">
                                ...
                                <div className="col-md-12 col-xl-5 mb-5">
                                    ...
                                    <Link href="research-papers/detail"><button type="button" className="btn filled-btn">Read Abstract</button></Link>
                                </div>
